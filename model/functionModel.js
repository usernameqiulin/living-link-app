...
export default class addActionModel extends Bone.Model {
  ...
  // }
func(){
    let otherfuncs = JSON.data.abilityDsl.events.outputData;
    
    console.log("funcs", otherfuncs)
     return {
       ...this.state,
       otherfuncs,
     };
  ...
  async loadFunctionList(device) {
    ...
    try {
      ...
      otherfuncs = ablityListRes.data.abilityDsl.events.outputData;
      console.log("ablityListRes>>>****>>!!!", ablityListRes.data, otherfuncs)
